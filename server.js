...
const allowedOrigins = [
  ...
  'http://officialtoolstore.com',
  'http://www.officialtoolstore.com',
  'https://api.officialtoolstore.com',
  'http://api.officialtoolstore.com',
...
app.use(cors({
  origin: (origin, cb) => {
    ...
    cb(null, false) // Gracefully deny CORS without throwing 500 server crash errors
  },
  credentials: true,
}))
...
// Disable mongoose command buffering globally to fail fast instead of hanging when offline
